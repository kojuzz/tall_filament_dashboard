                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-4">
                            ...
                            @error('street_address') <div class="text-sm text-red-500"> {{ $message }} </div> @enderror
                        </div>
                        <div class="mt-4">
                            ...
                            @error('city') <div class="text-sm text-red-500"> {{ $message }} </div> @enderror
                        </div>
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                @error('state') <div class="text-sm text-red-500"> {{ $message }} </div> @enderror
                            </div>
                            <div>
                                ...
                                @error('zip_code') <div class="text-sm text-red-500"> {{ $message }} </div> @enderror
                            </div>  
                        </div>
                    </div>
                            ...
                            <li class="py-3 sm:py-4" wire:key='{{ $item["product_id"] }}'>
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="{{ $item["name"] }}" class="w-12 h-12 rounded-lg object-cover"
