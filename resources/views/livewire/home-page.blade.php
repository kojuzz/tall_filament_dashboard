            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Ecommerce Demo with <span class="text-blue-600">STRIPE Payment</span>
                    </h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">
                        Laravel, Livewire with Filament, Tailwind CSS and Stripe Payment Gateway
                    </p>
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-md"
                        src="{{ asset('images/ecommerce-slide.png') }}"
                        ...
                        <div class="p-4 md:p-5">
                            <div class="flex justify-between items-center">
                                <div class="flex items-center">
                                    <img class="h-[2.375rem] w-[2.375rem] rounded-full object-contain"
